...
const Footer = () => {
  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    // Show success message (you would integrate with your actual form handler)
  ...
  return (
    <footer className="bg-card border-t border-border">
      ...
      <div id="contact" className="border-b border-border">
              ...
              <div className="flex space-x-4 mt-8">
                {socialLinks.map((social) => (
                  <a
                    key={social.label}
                    href={social.href}
                    className="w-10 h-10 rounded-lg glass border-glass-border flex items-center justify-center hover:bg-primary/10 transition-all duration-200 hover-lift"
        ...
        <div className="grid lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Supercharge your marketing with AI-powered insights, automation, 
              and optimization that delivers real results.
            </p>
